	...
	public void show() {
		...
		personalizarBoton.addListener(new InputListener() {
			...
			public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
				Gdx.app.log(MyGdxGame.LOG, "Touching down on " + personalizarBoton.getClass().getSimpleName());
				return true;
			}
			
			@Override
			public void touchUp(InputEvent event, float x, float y, int pointer, int button) {
				Gdx.app.log(MyGdxGame.LOG, "Touching up on " + personalizarBoton.getClass().getSimpleName());
