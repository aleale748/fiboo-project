...
public class AyudaPlaySacoScreen extends AbstractScreen {

	private Image pantallaAyuda;
	private Image imgFondo;
	private Image playBoton;
	
	public AyudaPlaySacoScreen(fibooGame game) {
		super(game);
	...
	public void show() {
		...
		Texture ayuda = fibooGame.MANAGER.get("sacominigame/pantallainiciobolsa.png", Texture.class);
